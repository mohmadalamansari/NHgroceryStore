    ...
    <div>
      <div className="mx-auto max-w-7xl px-4">
        ...
        <div className="flex flex-col space-y-8 pb-10 pt-12 md:pt-24">
          ...
          <p className="mx-auto max-w-4xl text-center text-base text-gray-600 md:text-2xl">
            NH Grocery Shop is your one-stop destination for all your grocery needs.
            We offer a wide range of high-quality products at affordable prices,
            ensuring that you can find everything you need to keep your pantry stocked and your meals delicious.

          </p>
          <p className='md:text-xl'>
          Whether you're looking for fresh produce, pantry staples, or specialty items, 
            our friendly staff is here to assist you and provide personalized service. 
            We strive to create a welcoming and convenient shopping experience for our customers, 
            so you can focus on enjoying delicious meals with your loved ones.
          </p>
        </div>
            ...
            <div className="w-auto p-8">
              <a href="#">
                <div className="inline-flex items-center">
                  <span className="ml-4 text-lg font-bold">NH</span>
                </div>
              </a>
            </div>
            <div className="w-auto p-8">
              <ul className="-m-5 flex flex-wrap items-center">
                ...
                <li className="p-5">
                  <a className="font-medium text-gray-600 hover:text-gray-700 sticky" href="#">
                    Terms of Service
                  </a>
                </li>
                <li className="p-5">
